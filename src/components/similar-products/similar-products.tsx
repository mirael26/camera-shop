...
const SimilarProducts = (): JSX.Element | null => {
  ...
  const findSimilarProducts = (referenceProduct: IProduct, allProducts: Array<IProduct>) => {
    ...
    const filteredProducts = allProducts.filter((product) => product.type === type || product.level === level || product.category === category);
    return filteredProducts;
  };

  const similarProducts = currentProduct && products ? findSimilarProducts(currentProduct, products) : null;
  /*eslint-disable*/
